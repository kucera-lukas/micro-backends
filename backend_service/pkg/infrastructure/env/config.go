...
type Config struct {
	...
	MongoServiceAddress    string      `mapstructure:"MONGO_SERVICE_ADDRESS"`
	PostgresServiceAddress string      `mapstructure:"POSTGRES_SERVICE_ADDRESS"`
...
func getEnvDefaultKeys() []string {
	return []string{
		"PORT",
		"MONGO_SERVICE_ADDRESS",
		"POSTGRES_SERVICE_ADDRESS",
		"RABBITMQ_URI",
	}
}
